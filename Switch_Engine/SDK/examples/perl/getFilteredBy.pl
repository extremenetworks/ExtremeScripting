...
###
##
##  This is an example on how to use GET XML API filtered by Some Attribute values.
##  It will read switch ip, username and password from the command line
##
##  Example: "perl getFilteredBy.pl 10.0.0.1 admin password"
##  
### 
######
...
my $filterParam ="adminState";  #This is the Filter Paramater , please refer SDK for meaning Get Filtered By API 
my $filterParamValue ="Enabled";   # This is the Filter Parameter Value 


# assemble request
my @params = (  SOAP::Data->name("filter" =>
                              \SOAP::Data->value(SOAP::Data->name("$filterParam" => $filterParamValue)))
                          ->type($ns.":".$objectType),
