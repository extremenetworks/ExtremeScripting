...
###
##
##  This is an example on how to use GET ALL XML API.
##  It will read  switch ip, username and password from the command line
##
##  Example: "perl portUtilization.pl 10.0.0.1 admin password"
##  
### 
######
...
my $ns = "port"; #name space of associated Object Type 
my $objectType = "PortUtilizationStats";   # Object Type, please refer SDK for list of available object types 

# assemble request
my @params = (  SOAP::Data->name("filter" => "")->type($ns.":".$objectType),
