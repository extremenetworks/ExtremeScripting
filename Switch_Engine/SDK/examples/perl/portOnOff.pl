...
##
##  Example: "perl portOnOff.pl 10.0.0.1 admin password"
##  
### 
######
...
my $setParam = "adminState"; # Parameter Name to be set, Please check SDK for PortConfig parameters
my $setParamValue = "Disabled"; # Parameter Value, please check SDK for Parameter value type
