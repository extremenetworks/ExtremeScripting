...
##
##  Example: "perl getOneSlot.pl 10.0.0.1 admin password"
##  
### 
######
...
my $ns = "system"; #name space of associated Object Type, in this case it is Port
my $objectType = "SlotInfo";   # Object Type, please refer SDK for list of available object types 
my $indexParam ="slotNumber";  #This is the Index Paramater for SlotInfo, please refer SDK for the menaing of Index Param
my $indexParamValue ="1";   # This is the Index Parameter Value
...
my @slotInfo =  $response->valueof('//objects/object');;

print Dumper(@slotInfo);
