...
#  
#
#  Copyright (c) Extreme Networks Inc.    2010,2011
#
#
###
##
##  This is an example on how to use the ID manager identity object API.
##  It will read switch ip, username and password from the command line
##
##  Example: "perl getIdMgr.pl 10.0.0.1 admin password"
##  
### 
######
...
my $ns = "idmgr";
my $objectType = "UserIdentityData"; # This is the object we are requesting
my $indexParam ="datasetType"; # This is the one filter parameter we will specify
my $indexParamValue ="active"; # This can be either active or event
