...
|[edp_and_port_vlan_check.py](edp_and_port_vlan_check.py)| This Script uses EDP to check if the local and remote port have the same vlans added to the ports.|
