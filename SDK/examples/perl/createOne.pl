...
##
##  Example: "perl createOne.pl 10.0.0.1 admin password"
##  
### 
######
...
my $indeParamValue ="testVlan";   # This is the Index Parameter Value
my $setParam = "vrName"; # Parameter Name to be set, Please check SDK for VlanConfig parameters
my $setParamValue = "VR-Default"; # Parameter Value, please check SDK for Parameter value type


# assemble request
my @params = (  SOAP::Data->name("filter" =>
                            \SOAP::Data->value(SOAP::Data->name("$indexParam" => $indeParamValue), 
                                               SOAP::Data->name("$setParam" => $setParamValue)))
                                       ->type($ns.":".$objectType),
