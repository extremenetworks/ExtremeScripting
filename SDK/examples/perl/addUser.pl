...
##
##  Example: "perl addUser.pl 10.0.0.1 admin password"
##  
### 
######
...
my $ns = "aaa"; #name space of associated Object Type, in this case it is vlan
my $objectType = "UserAccount";   # Object Type, please refer SDK for list of available object types 
my $indexParam ="userName";  #This is the Index Paramater for UserAccount, please refer SDK for the meaning of Index Param
my $indeParamValue ="testUser";   # This is the Index Parameter Value
my $setParam = "password"; # Parameter Name to be set, Please check SDK for UserAccount parameters
my $setParamValue = "abc123"; # Parameter Value, please check SDK for Parameter value type
