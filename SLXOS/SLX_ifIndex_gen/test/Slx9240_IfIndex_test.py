...
class TestSlx9240_IfIndex(unittest.TestCase):
    @staticmethod
    ...
    def test_line_card(self):
        for test_value in ['72X10G', '72X10g', '60x40G', '36X100G', '36x100g']:
            with self.subTest(test_value):
                ...
                self.assertRaises(ValueError, Slx9240_IfIndex, **args)
        return

    def test_portspeed_1to32(self):
    ...
    def test_portspeed_1to32_breakout(self):
        for test_value in ['1g', '10G', '25G', '40g', '50g', '100g', '']:
            with self.subTest(test_value):
    ...
    def test_1to32_port_output(self):
        args = {'speed': '100g', 'interface': 'e 0/1'}
        dummy = Slx9240_IfIndex(**args)
        intf_string = '000011'
    ...
    def test_1to32_breakout_port_output(self):
        args = {'speed': '100g', 'interface': 'e 0/1'}
        dummy = Slx9240_IfIndex(**args)
        intf_string = '000011'
