...
class TestSlx9640_IfIndex(unittest.TestCase):
    @staticmethod
    ...
    def test_line_card(self):
        for test_value in ['72X10G', '72X10g', '60x40G', '36X100G', '36x100g']:
            with self.subTest(test_value):
                ...
                self.assertRaises(ValueError, Slx9640_IfIndex, **args)
        return

    def test_portspeed_1to24(self):
    ...
    def test_portspeed_25to36(self):
        for test_value in ['1g', '10g', '25g', '40G', '50g', '100G', '']:
            with self.subTest(test_value):
                args = {'interface': 'e 0/25'}
                args['speed'] = test_value
                self.assertRaises(ValueError, Slx9640_IfIndex, **args)
        return

    def test_portspeed_25to36_breakout(self):
        for test_value in ['1g', '10G', '25G', '40g', '50g', '100g', '']:
            with self.subTest(test_value):
                args = {'interface': 'e 0/25:1'}
                args['speed'] = test_value
                self.assertRaises(ValueError, Slx9640_IfIndex, **args)
        return

    def test_portspeed_1to24_breakout(self):
        for test_value in ['1g', '10G', '25G', '40g', '50g', '100g']:
            with self.subTest(test_value):
                args = {'interface': 'e 0/1:1'}
                args['speed'] = test_value
                self.assertRaises(TypeError, Slx9640_IfIndex, **args)
        return
    ...
    def test_25to36_port_output(self):
        args = {'speed': '100g', 'interface': 'e 0/25'}
        dummy = Slx9640_IfIndex(**args)
        intf_string = '000011'
    ...
    def test_25to36_breakout_port_output(self):
        args = {'speed': '100g', 'interface': 'e 0/25'}
        dummy = Slx9640_IfIndex(**args)
        intf_string = '000011'
    ...
    def test_1to24_port_output(self):
